    ...
    <div class="rp-sheet">
      <div class="rp-header">
        <div class="rp-header-left">
          <img class="rp-logo" src="${REMITO_LOGO_B64}" alt="Corralón Domus"/>
          <div class="rp-company-info">
            <div class="rp-company">Corralón Domus</div>
            <div class="rp-sub">Materiales para la Construcción</div>
            ${COMPANY_INFO.direccion?`<div class="rp-contact">${escapeHtml(COMPANY_INFO.direccion)}</div>`:""}
            ${(COMPANY_INFO.telefono||COMPANY_INFO.email)?`<div class="rp-contact">${[COMPANY_INFO.telefono,COMPANY_INFO.email].filter(Boolean).map(escapeHtml).join(" · ")}</div>`:""}
            ${COMPANY_INFO.redes?`<div class="rp-contact">${escapeHtml(COMPANY_INFO.redes)}</div>`:""}
          </div>
        </div>
